...
This repository contains a differentiable, 3D mesh renderer using PyTorch. It is a port of Google's [tf_mesh_renderer](https://github.com/google/tf_mesh_renderer) from Tensorflow to PyTorch.
